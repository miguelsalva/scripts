...
#
# This script requires the AWS CLI installed/configured and the $DOMAIN and $HOSTED_ZONE variables defined to run 


DOMAIN=""  # AWS domain to be updated
HOSTED_ZONE_ID=""  # AWS hosted zone ID of the domain to be updated

JSON_FILE="$HOME/update_route53.json"
